...
public:
  ...
  virtual ~Scene()
  {
    ...
    // Textures need to be handled in the appropriate subclass,
    // because at this point only a forward declaration exists
    // and it is not clear whether the destructor is virtual.
