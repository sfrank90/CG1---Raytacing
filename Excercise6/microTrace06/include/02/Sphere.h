...
class Sphere: public Primitive02
{
public:
  Vec3f center;
  float radius;

  Sphere(Vec3f center, float radius, Light *light, Vec3f color)
      : Primitive02(color, light), center(center), radius(radius)
  {
  }

  virtual string getClassName() const
  {
    return string("sphere02");
  }
